...
subtitle: " ""A survey of economic mobility across generations in contemporary USA""  "
author: "Submitted By: Pragya Mishra (pragyam3)"
date: "Submitted On: 08/01/2019"
output:
...
1.Hands on experince with real life datasets.
2.Practise with all techniques learnt in STAT420.
3.Discover how applied statistics can help us answer socio-economic questions.
...
I have Six models to dignose: `firstModel`,`secondModel` and `thirdModel` and their transformed `log` versions.
...
I chose the `secondLog` model as our final one, even of its issues with multicollinearity, its still the best in terms of `Adjusted R2` value.
